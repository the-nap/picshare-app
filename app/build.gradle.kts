...
android {
    ...
    buildTypes {
        debug {
            ...
            buildConfigField("String", "MEDIA_URL", "\"https://amoeba-immense-macaw.ngrok-free.app/media/\"")
            buildConfigField("String", "AVATAR_URL", "\"https://amoeba-immense-macaw.ngrok-free.app/media/avatar\"")
